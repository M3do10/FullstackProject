...
const sampleProducts = [
    ...
    { name: "Ultra-Wide Monitor 27-inch", description: "4K UHD IPS display with 144Hz refresh rate", price: 329.99, category: "Electronics", stock: 20, image: "https://hp.widen.net/content/mhca8kbdun/png/mhca8kbdun.png?w=800&h=600&dpi=72&color=ffffff00" },
    ...
    { name: "External Solid State Drive 1TB", description: "High-speed portable NVMe SSD with USB 3.2 support", price: 109.99, category: "Electronics", stock: 55, image: "https://www.sandisk.com/content/dam/store/en-us/assets/products/internal-storage/ssd-plus-sata-iii-ssd/gallery/ssd-plus-sata-iii-ssd-left.png.wdthumb.1280.1280.png" },
    ...
    { name: "USB USB-C Multiport Hub", description: "7-in-1 adapter with HDMI 4K, SD reader, and 100W power delivery", price: 34.99, category: "Electronics", stock: 130, image: "https://m.media-amazon.com/images/I/61CFiwFj3KL.jpg" },
    ...
    { name: "Leather Casual Belt", description: "100% genuine full-grain leather dress belt", price: 29.99, category: "Clothing", stock: 160, image: "https://m.media-amazon.com/images/I/41KE5w4NdvL._SS500_.jpg" },
    { name: "Puffer Winter Vest", description: "Insulated sleeveless zip jacket with fleece collar", price: 49.99, category: "Clothing", stock: 70, image: "https://www.bows-n-ties.com/28501-xlarge_default/womens-suit-vest-in-medium-gray.jpg" },
